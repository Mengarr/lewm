"""Train a convolutional CLS-token decoder on top of a frozen JEPA encoder (encoder-only, no predictor)."""
...
from lewm.decoder import ConvDecoder
...
@hydra.main(version_base=None, config_path="./config/train", config_name="encoder_decoder_conv")
def run(cfg):
    #########################
    ##       dataset       ##
    #########################
    ...
    decoder = ConvDecoder(**cfg.decoder)
